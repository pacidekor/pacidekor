  ...
  return (
    <div className="mt-8 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <button
          type="button"
          className="inline-flex h-12 flex-1 cursor-pointer items-center justify-center gap-2 rounded-full bg-[#75825B] px-6 text-base font-medium text-white transition-opacity hover:opacity-90"
        >
