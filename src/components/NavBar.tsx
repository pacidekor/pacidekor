...
export function NavBar() {
  ...
  return (
    <nav aria-label="Hlavní navigace" className="relative">
      ...
      >
        <div
          className={`border-b border-black/5 bg-[#faf8f5] shadow-[0_16px_40px_rgba(45,35,25,0.12)] transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform ${
